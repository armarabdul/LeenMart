import type { Clock, IdGenerator, Uuid } from '@leen-mart/domain-kit';
...
export class SessionIssuer {
  ...
  async issueFor(user: User): Promise<AuthSession> {
    const { accessTokenService, refreshTokenHasher, refreshTokenRepository, idGenerator, clock, refreshTtlDays } =
      this.deps;
