...
/**
 * This app only ever asks for the CUSTOMER inbox (S6-NOTIFY-INAPP).
 *
 * The kind is a request parameter rather than a property of the session
 * because one person can be both: a vendor owner buys here and sells in the
 * portal on the same account. Hard-coding it in this app is what keeps a
 * vendor's "New order" notifications out of a shopper's list.
 */
const KIND = 'CUSTOMER';
